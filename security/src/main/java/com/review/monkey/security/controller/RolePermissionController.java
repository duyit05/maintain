...
public class RolePermissionController {
    ...
    @PostMapping
    public ApiResponse<RolePermissionResponse> createRoleAndPermission(
            @RequestParam String roleId, @RequestParam String permissionId) {
    ...
    @PutMapping
    public ApiResponse<RolePermissionResponse> updateRoleAndPermissionByRolePermissionId(
            @RequestParam int rolePermissionId, @RequestParam String permissionId) {
        return ApiResponse.<RolePermissionResponse>builder()
