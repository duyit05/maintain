...
public class RolePermissionImplement implements RolePermissionService {
    ...
    public RolePermissionResponse createRoleAndPermission(String roleId, String permissionId) {
        ...
        if (checkExisted.isPresent()) {
            throw new RuntimeException("THIS ROLE HAVED PERMISSION : "
                    + checkExisted.get().getPermission().getPermissionName());
        }
    ...
    public RolePermissionResponse updateRoleAndPermission(int rolePermssionId, String permissionId) {
        ...
        if (checkExisted.isPresent()) {
            ...
            Optional<RolePermission> check = rolePermissionRepository.findRoleAndPermissionAndRolePermissionId(
                    rolePermssionId, rolePermission.getRole().getRoleId(), permissionId);
            ...
            Permission permission =
                    Permission.builder().permissionId(permissionId).build();
    ...
    public void deleteroleAndPermissionById(int rolePermissionId) {
        RolePermission checkExisted = rolePermissionRepository
