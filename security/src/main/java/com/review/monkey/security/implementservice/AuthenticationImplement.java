...
import com.review.monkey.security.repository.OutboundIdentityClient;
import com.review.monkey.security.request.*;
import com.review.monkey.security.response.ExchangeTokenResponse;
...
public class AuthenticationImplement implements AuthenticationService {
    ...
    public AuthenticationResponse authentication(AuthenticationRequest request) {
        User checkUserExisted = userRepository
    ...
    public void logout(LogoutRequest request) throws ParseException, JOSEException {
        try {
            ...
            InvalidatedToken invalidatedToken =
                    InvalidatedToken.builder().id(jit).expiryTime(expirtyTime).build();
    ...
    public SignedJWT verifyToken(String token, boolean isRefresh) throws JOSEException, ParseException {
        ...
        Date expiryTime = (isRefresh)
                ...
                .getIssueTime()
                .toInstant()
                .plus(REFRESABLE_DURATION, ChronoUnit.SECONDS)
                .toEpochMilli())
