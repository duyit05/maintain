...
public class RoleImplement implements RoleService {
    ...
    public RoleResponse createRole(RoleRequest request) {
        ...
        if (roleRepository.existsByRoleName(request.getRoleName())) throw new AppException(ErrorCode.ROLE_NAME_EXISTED);
    ...
    public RoleResponse updateRoleById(String roleId, RoleRequest request) {
        Role role = roleRepository
                .findById(roleId)
                .orElseThrow(() -> new RuntimeException("CAN'T UPDATE ROLE WITH ID : " + roleId));
    ...
    public void deleteRoleById(String roleId) {
        Role role = roleRepository
                .findById(roleId)
                .orElseThrow(() -> new RuntimeException("CAN'T DELETE ROLE WITH ID : " + roleId));
    ...
    public RoleResponse getRoleById(String roleId) {
        ...
        return roleMapper.toRoleResponse(roleRepository
                .findById(roleId)
                .orElseThrow(() -> new RuntimeException("CAN'T GET ROLE BY WITH ID : " + roleId)));
    }
}
